...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).sorted(Comparator.comparingInt(integer -> integer));
    ...
    public void top3RichCustomer() {
        ...
        Stream<String> top3RichCustomerStream = customerList.stream()
                                                            .sorted((cus1, cus2)-> cus2.getBudget()-cus1.getBudget())
