...
public class Exercise8Test extends ClassicOnlineStore {
    ...
    public void itemsNotOnSale() {
        ...
        Set<String> itemSetNotOnSale = customerStream.flatMap(c->c.getWantToBuy().stream()).map(Item::getName).filter(it-> !itemListOnSale.contains(it)).collect(Collectors.toSet());
